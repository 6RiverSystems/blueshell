...
const nodeShapeLegend = `
	Selector [${SelectorShape} ${DefaultColor}];
	LatchedSelector = [${LatchedSelectorShape} ${DefaultColor}];
	Sequence = [${SequenceShape} ${DefaultColor}];
	LatchedSequence = [${LatchedSequenceShape} ${DefaultColor}];
	IfElse = [${IfElseShape} ${DefaultColor}];
	Not = [${NotShape} ${DefaultColor}];
	RepeatOnResult = [${RepeatOnResultShape} ${DefaultColor}];
	RepeatWhen = [${RepeatWhenShape} ${DefaultColor}];
	ResultSwap = [${ResultSwapShape} ${DefaultColor}];
	Action = [${DefaultShape} ${DefaultColor}];
`;
