...
export function toString<S extends BlueshellState, E>(
	tree: Action<S, E>, state?: S, contextDepth = Number.MAX_SAFE_INTEGER
): string {
...
export function toDotString<S extends BlueshellState, E>(tree: Action<S, E>, state?: S) {
	return serializeDotTree(tree, state);
}

export function toDotConsole<S extends BlueshellState, E>(tree: Action<S, E>, state?: S) {
